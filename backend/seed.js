...
// Curated products with real names, brands, prices, and actual Unsplash images
...
// Product Generator - Creates realistic products from database
...
export const seedDatabase = async () => {
  try {
    console.log('\n========================================');
    console.log('BlinkBasket Database Seeding Started');
    console.log('========================================\n');
    ...
    console.log('✓ Admin created: admin@blinkbasket.com / admin123');
    ...
    for (const seller of sellers) {
      ...
      console.log(`✓ Seller: ${seller.name} - ${seller.email} / seller123`);
    }
    
    // Assign categories to sellers
    const categoryAssignments = [
      ['Electronics'],                        // TechWorld
      ['Men\'s Fashion', 'Women\'s Fashion'], // Fashion Hub
      ['Home & Kitchen'],                     // Home Essentials
      ['Beauty & Personal Care'],             // Beauty Palace
      ['Sports & Fitness', 'Toys & Games'],   // Sports Zone
    ];
    ...
    // Add grocery and books to admin
    const adminProducts = [
    ...
    console.log(`  → Admin (Grocery & Books): ${adminProducts.length} products`);
    ...
    const categoriesInDB = await Product.find().distinct('category');
    console.log('\n→ Categories in database:', categoriesInDB);
    
    console.log('\n========================================');
    console.log(`✓ Seeding Completed! ${totalProducts} Realistic Products`);
    console.log(`✓ Categories: ${categoriesInDB.length}`);
    console.log('========================================\n');
